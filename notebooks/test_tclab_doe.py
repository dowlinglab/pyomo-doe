...
data_files = ['../data/validation_experiment_env_2_sin_5_50_run_{}.csv'.format(i + 1) for i in range(3)]
...
if number_of_states == 4:
    ...
    theta_vals = {'Ua': 0.04170517, "Ub": 0.01995270, 'inv_CpH': 0.17268539, 'Uc': 0.01340118, 'inv_CpS': 2.65286797, }
...
TC_Lab_DoE.run_doe(results_file="test_solve_A_opt_{}_states_3_priors.json".format(number_of_states))

with open("test_solve_A_opt_{}_states_3_priors.json".format(number_of_states)) as f:
    d = json.load(f)
